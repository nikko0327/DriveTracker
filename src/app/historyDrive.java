 ...
 */
public class historyDrive extends HttpServlet implements mysql_credentials {
    ...
    public boolean getSearchResult(String assetTag, String serialNumber, String customerName,
        ...
        try{
            ...
            System.out.println("History drive: " + query_searchDrive);
