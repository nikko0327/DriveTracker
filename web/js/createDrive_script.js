...
//
//     /*
//     $('#drive_state').on('change', function() {
//         if($(this).val().startsWith("Received")) {
//             $('#sent_date').parent().siblings("label").html("Received Date");
//         }
//         else {
//             $('#sent_date').parent().siblings("label").html("Sent Date");
//         }
//     });*/
//
...
//                         + "<br>Drive Status: " + data.drive_state  //Drive State is changed to Drive Status
//                         + "<br>Received Date: " + data.received_date;
//                     /*if(data.drive_state.startsWith("Shipped")) {
//                         result += "<br>Sent Date: " + data.sent_date
//                             + "<br>Shipping Carrier: " + data.shipping_carrier
//                             + "<br>Shipping Tracking Number: " + data.shipping_tracking_number;
//                     }*/
//
